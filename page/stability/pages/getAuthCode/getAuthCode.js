...
Page({
  ...
  onLoad() {
    ...
    //     }
    //   },
    this.Qunit.test("getAuthCode获取授权码_参数为数组", "getAuthCode获取授权码_参数为数组 callback测试", function (assert) {
    ...
    this.Qunit.test("getAuthCode获取授权码_参数为空", "getAuthCode获取授权码_参数为空 callback测试", function (assert) {
    ...
    this.Qunit.test("getAuthCode获取授权码_参数为数字", "getAuthCode接口_参数为数字 callback测试", function (assert) {
    ...
    this.Qunit.test("getAuthCode获取授权码_参数为符号", "getAuthCode获取授权码_参数为符号 callback测试", function (assert) {
    ...
    this.Qunit.test("getAuthCode获取授权码_参数为布尔值", "getAuthCode获取授权码_参数为布尔值 callback测试", function (assert) {
    ...
    this.Qunit.test("getAuthCode获取授权码-complete回调", "getAuthCode获取授权码-complete callback测试", function (assert) {
      my.getAuthCode({
        scopes: 'auth_base',
        complete: (res) => {
          console.log(JSON.stringify(res))
